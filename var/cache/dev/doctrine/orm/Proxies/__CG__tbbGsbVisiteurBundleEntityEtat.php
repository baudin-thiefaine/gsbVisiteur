 ...
 */
class Etat extends \tbbGsbVisiteurBundle\Entity\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'tbbGsbVisiteurBundle\\Entity\\Etat' . "\0" . 'id', '' . "\0" . 'tbbGsbVisiteurBundle\\Entity\\Etat' . "\0" . 'libelle'];
        }
